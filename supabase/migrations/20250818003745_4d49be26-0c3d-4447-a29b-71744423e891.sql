...
DROP TRIGGER IF EXISTS prevent_role_escalation_trigger ON profiles CASCADE;
DROP TRIGGER IF EXISTS enforce_role_security ON profiles CASCADE;
DROP TRIGGER IF EXISTS prevent_privilege_escalation_enhanced ON profiles CASCADE;
DROP TRIGGER IF EXISTS audit_role_changes_trigger ON profiles CASCADE;
DROP TRIGGER IF EXISTS audit_user_deletion_trigger ON profiles CASCADE;
DROP TRIGGER IF EXISTS audit_user_archiving_trigger ON profiles CASCADE;

-- Now drop all security functions with CASCADE
