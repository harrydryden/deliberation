...
-- 4. Add constraint to prevent direct role escalation
ALTER TABLE public.profiles ADD CONSTRAINT prevent_self_admin_escalation 
CHECK (
    user_role != 'admin' OR 
    id IN (
...
-- 7. Strengthen access code constraints
