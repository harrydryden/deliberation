...
-- 2. Fix profiles table role column inconsistency and strengthen policies
-- Drop existing policies that might have inconsistent role references
...
-- Update the get_current_user_role function to use consistent column name
...
-- 3. Fix prevent_role_escalation trigger to use consistent role column
...
-- 4. Add more restrictive access code policies for admin operations
