-- Remove all RLS policies and security measures
-- Drop triggers first, then functions to avoid dependency issues

-- Drop all security triggers first
...
-- Keep access code validation functions for frontend authentication