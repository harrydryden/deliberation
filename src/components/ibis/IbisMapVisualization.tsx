  ...
  const convertToFlowNodes = (ibisNodesData: IbisNode[], relationshipsData: IbisRelationship[] = []) => {
    ...
    relationshipsData.forEach(relationship => {
      ...
      if (filteredNodeIds.has(relationship.source_node_id) && filteredNodeIds.has(relationship.target_node_id)) {
        ...
        // Check if this is a system-generated relationship
        const isSystemGenerated = relationship.created_by === null;
        ...
        flowEdges.push({
          ...
          type: 'smoothstep',
          animated: false,
          className: isSystemGenerated ? 'system-generated-relationship' : 'manual-relationship',
          style: { 
            stroke: config.color, 
            strokeWidth: 4,
