...
const Index = () => {
  ...
  const checkForLastDeliberationAndRedirect = async () => {
    try {
      ...
      productionLogger.error('Failed to check for last deliberation', error);
      loadDeliberations();
    }
  };
  ...
  const loadDeliberations = async () => {
    try {
      ...
      productionLogger.error('Failed to load deliberations', error);
      setDeliberations([]);
    }
  };
  if (!user) {
        ...
        <CardContent className="space-y-6">
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Actively listen to others' perspectives and be open to changing your mind.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="bg-muted/50 p-4 rounded-lg">
            ...
            <ul className="space-y-1 text-sm text-muted-foreground">
              ...
              <li>• Ask clarifying questions to better understand others</li>
              <li>• Focus on the merits of ideas, not personal attributes</li>
              <li>• Acknowledge when others make good points</li>
            </ul>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-4">
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
            ...
            <ul className="space-y-1 text-sm text-blue-800">
              ...
              <li>• Summarize key points and identify areas of agreement</li>
