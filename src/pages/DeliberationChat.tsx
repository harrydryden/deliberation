          ...
          <div className="hidden lg:block p-4">
            <div className="flex items-stretch gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="rounded-lg border bg-muted/40 p-3 h-25 flex flex-col justify-center">
              ...
              {/* Modes */}
              <div className="shrink-0">
                <div className="rounded-lg border bg-muted/40 px-3 py-2 h-25 flex flex-col justify-center space-y-2">
                  <div>
                    <div className="text-xs font-medium text-muted-foreground mb-1">Text Mode</div>
                    <ChatModeSelector mode={chatMode} onModeChange={setChatMode} variant="bare" />
                  </div>
              ...
              {/* Voice Interface */}
              <div className="shrink-0">
                <div className="rounded-lg border bg-muted/40 px-3 py-2 h-25 flex flex-col justify-center">
                  <Suspense fallback={<div className="text-xs text-muted-foreground">Loading voice…</div>}>
                    <VoiceInterfaceLazy deliberationId={deliberation.id} variant="panel" />
                  </Suspense>
                </div>
