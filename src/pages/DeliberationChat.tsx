  ...
  return (
    <Layout>
      <div className="h-[calc(100vh-120px)] flex flex-col bg-background rounded-lg border">
        {/* Deliberation Header - Sticky */}
        <div className="sticky top-0 z-10 border-b p-4 bg-card/95 backdrop-blur-sm">
        ...
        <div className="flex-1 flex flex-col">
          <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as 'chat' | 'ibis')} className="flex-1 flex flex-col">
            <div className="sticky top-[88px] z-10 border-b px-4 bg-background/95 backdrop-blur-sm">
